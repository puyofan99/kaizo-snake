...
int main(void)
{
  ...
  text((VWIDTH - 20) / 2, VHEIGHT / 2, "Press a key to saviour.", BACK_BLACK | FORE_BRIGHT_WHITE);
...
void play(void)
{
  ...
  box(0, 0, VWIDTH, VHEIGHT, ' ', BACK_GREEN | FORE_BLACK, 0);
  text((VWIDTH - 12) / 2, 0, "Money: ", BACK_BROWN | FORE_BLACK);
  score = 0;
  ...
  text((VWIDTH - 10) / 2, VHEIGHT / 2, "You failed. ", BACK_BLACK | FORE_BRIGHT_WHITE);
  delay(1000);
